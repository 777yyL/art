...
// Validate ../../../app/api/user/config/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user/config">> = Specific
  const handler = {} as typeof import("../../../app/api/user/config/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
